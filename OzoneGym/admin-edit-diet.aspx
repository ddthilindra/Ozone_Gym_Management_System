<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="admin-edit-diet.aspx.cs" Inherits="OzoneFitness.admin_edit_diet1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <link rel="stylesheet" href="./css/admin-diet.css">

    <title>OZONE - Admin Edit Diet</title>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Diets" runat="server">
    ...
    <div class="head">
        ...
        <form action="#" runat="server" class="diet-add-frm">
          <div class="form-group row container">
            <div class="col-md-1"></div>
              ...
              <div class="col-md-11">
                <asp:Button ID="updatediet" class="btn btn-primary" runat="server" Text="Update Diet" OnClick="updatediet_Click" />
              </div>
