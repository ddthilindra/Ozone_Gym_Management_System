<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="admin-add-schedule.aspx.cs" Inherits="OzoneFitness.admin_add_schedule" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="css/admin-add-schedule.css" rel="stylesheet" />

    <title>OZONE - Admin Add Shedule</title>
</asp:Content>
                          ...
                          <div class="tab">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <asp:TextBox ID="schedulen" class="form-control" placeholder="Name" runat="server" required></asp:TextBox>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <asp:TextBox ID="TextBox1" class="form-control" placeholder="Description"
                                        runat="server" MaxLength="50" required></asp:TextBox>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="btnsch">
                                        ...
                                        <asp:Button ID="submit"  class="btn btn-primary" runat="server" Text="Add" OnClick="submit_Click" />
                                    </div>
                                </div>
                            </div>
