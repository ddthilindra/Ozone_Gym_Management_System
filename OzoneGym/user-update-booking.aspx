<%@ Page Title="" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="user-update-booking.aspx.cs" Inherits="OzoneFitness.user_update_booking" %>
                          ...
                          <div class="tab">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <asp:TextBox CssClass="form-control" ID="adbDate" TextMode="Date" runat="server" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                        <div class="btndeit">
                                            ...
                                            <asp:Button ID="updatebook" class="btn btn-primary" runat="server" Text="Submit" OnClick="updatebook_Click"/>
