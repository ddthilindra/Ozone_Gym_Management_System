<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="employee-salary-edit.aspx.cs" Inherits="OzoneFitness.employee_salary_edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <link rel="stylesheet" href="./css/employee-salary-edit.css">

    <title>OZONE - Admin Edit salary Employee</title>
