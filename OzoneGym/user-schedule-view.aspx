<%@ Page Title="" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="user-schedule-view.aspx.cs" Inherits="OzoneFitness.user_schedule_view" %>
          ...
          <div class="row container">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <center>
                      <a href="user-add-schedule.aspx?Schedule_Id= <%# Eval("Schedule_Id") %>" class="btn btn-primary">Select</a>
